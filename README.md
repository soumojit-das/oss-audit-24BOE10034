...
# Student Name: Soumojit Das
# Registration No : 24BOE10034
# Selected Software: Python (open source)

# About the Project
This project will conduct a structured audit of Python as an open-source technology through a combination of conceptual understanding and practical implementation using shell scripts in a Linux environment.

The scripts will provide insight into key system-level operations such as obtaining system information, checking for the existence of a Python installation, determining the permissions of files, reviewing the content of log files, and producing output based on input from users.
---
